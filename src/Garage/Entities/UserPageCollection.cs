...
public class UserPageCollection: List<UserPage>
{
    public string UserId { get; set; } = Defaults.Users.UserId;
    public string DisplayName { get; set; } = Defaults.Users.UserName;
    
    public static readonly UserPageCollection AnonymousDefaults = 
    [
        new UserPage
        {
